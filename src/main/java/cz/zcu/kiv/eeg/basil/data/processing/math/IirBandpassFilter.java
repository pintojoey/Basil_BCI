...
import cz.zcu.kiv.eeg.basil.data.processing.math.filter.biz.FilterCharacteristicsType;
import cz.zcu.kiv.eeg.basil.data.processing.math.filter.biz.FilterPassType;
import cz.zcu.kiv.eeg.basil.data.processing.math.filter.biz.IirFilter;
import cz.zcu.kiv.eeg.basil.data.processing.math.filter.biz.IirFilterCoefficients;
import cz.zcu.kiv.eeg.basil.data.processing.math.filter.biz.IirFilterDesignFisher;
 ...
 * @version 1.00
 */
public class IirBandpassFilter implements IFilter {
