...
public class LSLMarkerCollector extends Thread {
	private LSLEEGDataMessageProvider messageProvider; /* reference to EEG/ERP data provider */
	private volatile boolean running;
	
	public LSLMarkerCollector(LSLEEGDataMessageProvider messageProvider) {
